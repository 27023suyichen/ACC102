...
def main():
    ...
    if raw_data is None or raw_data.empty:
        st.error("❌ Failed to download data. Please try again or select different stocks.")
        return
    ...
    with tab2:
        ...
        prices_melted = close_prices.melt(var_name='Ticker', value_name='Price')
        sns.boxplot(data=prices_melted, x='Ticker', y='Price', ax=ax, palette='Set2')
